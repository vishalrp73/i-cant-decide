import alwaysSunny from "./always-sunny.json" assert { type: "json" };
import americanDad from "./american-dad.json" assert { type: "json" };
import bobsBurgers from "./bobs-burgers.json" assert { type: "json" };
import clevelandShow from "./cleveland-show.json" assert { type: "json" };
import familyGuy from "./family-guy.json" assert { type: "json" };
import futurama from "./futurama.json" assert { type: "json" };
import kingOfTheHill from "./koth.json" assert { type: "json" };
import scrubs from "./scrubs.json" assert { type: "json" };
...
import { Episode } from "../tools/functions/types";
